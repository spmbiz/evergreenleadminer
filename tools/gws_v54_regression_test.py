...
def main():
    ...
    good_places=[{'id':'good-current','name':'Garage Louis & Fils','phones':['+32 2 523 47 80'],'addresses':[{'freeform':'Chaussée de Ninove 732, 1070 Anderlecht'}],'websites':[],'operating_status':''}]
